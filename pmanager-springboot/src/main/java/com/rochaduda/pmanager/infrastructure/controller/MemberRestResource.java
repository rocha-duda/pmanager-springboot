...
import static com.rochaduda.pmanager.infrastructure.controller.RestConstants.PATH_MEMBERS;
...
public class MemberRestResource {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<MemberDTO> updateMember(@PathVariable("id") String memberId, @Valid @RequestBody SaveMemberDataDTO saveMemberData){
